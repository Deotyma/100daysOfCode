...
class Game {
    ...
    gameOver() {
        ...
        if (won) {
            ...
            __('#game-over-message').textContent = 'Поздравляем! Ты выиграл! :D';
        } else {
            __('#overlay').className = 'lose';
            __('#game-over-message').textContent = 'Игра окончена! Вы потеряли все свои сердца ;(';
        }
        __('#overlay').style.display = 'flex';
        __('#btn__reset').textContent = 'Начать новую игру';
